                ...
                for($j=0; $j<count($datos);$j++)
                {
                	...
                	if($padrej!=0 && $datos[$j]['est']==0)
                	{
                		if($datos[$j]['idParent']==$vinculo)
                		{
                             ...
                             switch($datos[$j]['text'])
                            {
                                case $this->param['param_tarea']:
                                    echo '                            
                                    <li class="active"><a href="../../'.$datos[$j]['url'].'">
                                    <i class="fa '.$datos[$j]['estilo'].'"></i> '.$datos[$j]['text'].'</a></li>

                                ';
                                break;
                                default:
                                     echo '                            
                                    <li><a href="../../'.$datos[$j]['url'].'">
                                    <i class="fa '.$datos[$j]['estilo'].'"></i> '.$datos[$j]['text'].'</a></li>
