<?php 
  ...
  if(isset($_GET['code'])){
    ...
    $output = '<a class="btn btn-googleplus" ggle="tooltip" title="Login with Google" href="'.filter_var($authUrl, FILTER_SANITIZE_URL).'"><i aria-hidden="true" class="fa fa-google-plus"></i> </a>';
        ...
        <div class="login-register" style="background-image:url(../assets/images/background/login-register.jpg);">        
            ...
            <div class="card-body">
                <form class="form-horizontal form-material" id="loginform" action="index.html">
                    <h3 class="box-title m-b-20">Iniciar Sesión</h3><br>
                    ...
                    <div class="form-group m-b-0">
                        <div class="col-sm-12 text-center">
                            ...
                            <a class="text-info m-l-5"><b>Solicítala al Coordinador de Producción.</b></a>
                        </div>
                    </div>
                </form>
            </div>
