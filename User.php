           ...
           $prevQuery = "SELECT * FROM " . $this->userTbl . " WHERE email = '" . $userData['email'] . "'";
            ...
            if ($prevResult->num_rows > 0) {
                //Update user data if already exists
                 $query = "UPDATE " . $this->userTbl . " SET first_name = '" . $userData['first_name'] . "', last_name = '" . $userData['last_name'] . "', oauth_provider = '" . $userData['oauth_provider'] . "', oauth_uid = '" . $userData['oauth_uid'] . "', email = '" . $userData['email'] . "', locale = '" . $userData['locale'] . "', picture = '" . $userData['picture'] . "', modified = '" . date("Y-m-d H:i:s") . "' WHERE email = '" . $userData['email'] . "'";
                ...
                /*Insert user data id does not exist
